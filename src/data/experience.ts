export const leadership = [
  ...
  },
  {
    ...
    description:
      "Maintained, updated, and edited the honor society\u2019s website.",
  },
];
...
export const experience = [
  {
    ...
    description:
      "Developed an Excel inventory system deployed across 11 stores to improve stock tracking and reduce food waste. Oversaw daily operations and trained staff.",
  },
];
